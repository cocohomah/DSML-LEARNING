...
def login_tab():
    ...
    def login_check():
        ...
        if user not in data:
            ...
            email = user
            if role == "admin":
                subprocess.Popen([sys.executable, "/home/coder/Documents/DSML-LEARNING/TEST_PHASE/admin.py", email])
                window.destroy()  
            elif role == "customer":
                subprocess.Popen([sys.executable, "/home/coder/Documents/DSML-LEARNING/TEST_PHASE/customer.py", email])
                window.destroy()
            elif role == "delivery_agent":
                subprocess.Popen([sys.executable, "/home/coder/Documents/DSML-LEARNING/TEST_PHASE/delivery_agent.py", email])
                window.destroy()
